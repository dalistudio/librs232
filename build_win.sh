...
x86_64-w64-mingw32-gcc -fPIC -shared -DRS232_DEBUG -DRS232_EXPORT src/rs232.c src/rs232_windows.c -I include -o librs232.dll
x86_64-w64-mingw32-gcc src/rs232_test.c librs232.dll -I include -o test.exe
x86_64-w64-mingw32-gcc -fPIC -shared -DRS232_DEBUG -DRS232_EXPORT bindings/lua/luars232.c src/rs232.c src/rs232_windows.c -I include -llua -o luars232.dll
